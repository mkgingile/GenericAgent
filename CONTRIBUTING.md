...
>
> **Current focus:** exploring custom skill development and understanding the core agent loop. Tracking interesting patterns in `memory/` as a reference for building domain-specific skills later.
