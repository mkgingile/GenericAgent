...
class Session:
    ...
    def is_active(self):
        # Increased timeout from 60s to 180s to avoid premature disconnects on slow/heavy pages
    ...
    def mark_disconnected(self):
        # Only print the disconnect message if the session was actually active
